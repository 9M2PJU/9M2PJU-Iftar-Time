...
export const CountdownHero: React.FC<CountdownHeroProps> = ({ iftarTime, fajrTime, locationName, hijriDate }) => {
    ...
    return (
        <div className="relative w-full flex flex-col items-center justify-center py-1 sm:py-6 md:py-10">
            ...
            <h2 className="text-lg sm:text-3xl md:text-5xl lg:text-5xl xl:text-5xl 2xl:text-6xl font-bold text-white mb-2 sm:mb-6 md:mb-4 mt-1 sm:mt-4 md:mt-4 tracking-tight text-center transition-all duration-700">
                Time until <span className="text-emerald-400">Iftar</span>
            </h2>

            <div className="flex items-start gap-3 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-10 2xl:gap-12">
            ...
            <div className="w-full max-w-sm sm:max-w-md md:max-w-xl xl:max-w-2xl 2xl:max-w-3xl mt-4 sm:mt-8 md:mt-4 px-4">
