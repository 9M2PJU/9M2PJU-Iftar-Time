...
export const ZONE_NAMES: Record<string, string> = {
    ...
    'KTN02': 'Jeli, Gua Musang (Mukim Galas & Bertam), Kuala Krai (Mukim Dabong)',
    ...
    'SBH04': 'Bandar Tawau, Balung, Merotai, Kalabakan, Bahagian Tawau (Barat)',
    ...
    'SBH09': 'Beaufort, Kuala Penyu, Sipitang, Tenom, Long Pa Sia, Membakut, Weston, Bahagian Pedalaman (Bawah)',
    'SWK01': 'Limbang, Lawas, Sundar, Trusan',
    'SWK02': 'Miri, Niah, Bekenu, Sibuti, Marudi',
    'SWK03': 'Pandan, Belaga, Suai, Tatau, Sebauh, Bintulu',
    'SWK04': 'Sibu, Mukah, Dalat, Oya, Balingian, Kanowit, Kapit, Song',
